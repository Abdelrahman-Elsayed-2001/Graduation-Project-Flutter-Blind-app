...
class _chatscreenAIState extends State<chatscreenAI> {
                    ...
                    Expanded(
                      child: TextField(
                        ...
                        onSubmitted: (value) async {
                          messegeTraffic(modelsProvider,chatProvider);
                        },
  ...
  Future<void> messegeTraffic(modelsProvider,chatProvider) async {
    //input voice
    ...
    // print("5   "+textEditingController.text+"   5");
    // sendMessageLitha();
  ...
  Future<void> sendMessageLitha()async {
